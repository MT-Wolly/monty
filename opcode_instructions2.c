...
/**
* add - adds the first two elements at the top of stack
...
/**
* sub - subtracts the first element from the second in the stack
* @stack: pointer to the beginning of the stack
* @line_number: the line number of the byte code
* Return: Nothing
*/
...
/**
* divide - divides the second element from the first in the stack
* @stack: pointer to the beginning of the stack
* @line_number: the line number of the byte code
* Return: Nothing
*/
